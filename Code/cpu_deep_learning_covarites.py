...
Original file is located at
    https://colab.research.google.com/drive/1rleG3FH83t4hj6xrt2zbQJC2sHDxBNrV
"""
...
df = pd.read_excel(io.BytesIO(uploaded['Book2.xlsx']))
df.head()

cases = df[df.columns[[1]]]
covariates = df.drop(df.columns[[0,1]], axis = 1)

covariates = covariates.iloc[:,0:60]
