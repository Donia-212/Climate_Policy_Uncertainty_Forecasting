...
# ARFIMA
arfima_3 <- arfima(train_3$CPU_US, xreg = train_reg_reduced_3)
...
# ARIMA
arima_3 <- auto.arima(train_3$CPU_US, xreg = train_reg_reduced_3)
...
setwd('Climate_Policy_Uncertainty_Forecasting/Dataset/Dataset_Deep_Learning_Models_Forecasts/Models - Macroeconomic/US Alternate')
...
# ARFIMA
arfima_6 <- arfima(train_6$CPU_US, xreg = train_reg_reduced_6)
...
# ARIMA
arima_6 <- auto.arima(train_6$CPU_US, xreg = train_reg_reduced_6)
...
# ARFIMA
arfima_12 <- arfima(train_12$CPU_US, xreg = train_reg_reduced_12)
...
# ARIMA
arima_12 <- auto.arima(train_12$CPU_US, xreg = train_reg_reduced_12)
...
# ARFIMA
arfima_24 <- arfima(train_24$CPU_US, xreg = train_reg_reduced_24)
...
# ARIMA
arima_24 <- auto.arima(train_24$CPU_US, xreg = train_reg_reduced_24)
...
# ARNN
arnn_24 <- nnetar(train_24$CPU_US, xreg = train_reg_reduced_24, MaxNWts = 5500)
