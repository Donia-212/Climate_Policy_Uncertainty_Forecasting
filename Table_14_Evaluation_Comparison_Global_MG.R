...
setwd('Climate_Policy_Uncertainty_Forecasting/Dataset/Dataset_Deep_Learning_Models_Forecasts/Models - Macroeconomic + Google/Global')
...
# ARNN
arnn_24 <- nnetar(train_24$`GCPU(PPP-adjusted GDP)`, xreg = train_reg_reduced_24[,1:90], MaxNWts = 5500)
...
bsts_24 <- bsts(cpu_index ~ .,
                ...
                ping = 100,
                seed = 100,
                data = as.data.frame(cbind(train_24$`GCPU(PPP-adjusted GDP)`, train_reg_reduced_24[,1:90])) %>% rename('cpu_index' = V1))
